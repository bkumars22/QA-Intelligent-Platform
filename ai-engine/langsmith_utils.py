"""
LangSmith observability layer for QAIP (TestMind).
...
To enable:
  ...
  LANGCHAIN_PROJECT=QAIP-Production
"""
...
logger = logging.getLogger("qaip.langsmith")

_API_KEY = os.environ.get("LANGCHAIN_API_KEY", "")
_TRACING  = os.environ.get("LANGCHAIN_TRACING_V2", "").lower() == "true"
_PROJECT  = os.environ.get("LANGCHAIN_PROJECT", "QAIP-Production")
